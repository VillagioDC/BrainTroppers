...
// Add new node api 
export async function toggleLinkTypeApi ({projectId, nodeIdFrom, nodeIdTo, linkType}) {
    try {
        // Set parameters
        ...
        // Construct body
        const body = { userId, projectId, nodeIdFrom, nodeIdTo, linkType};
        const url = setApiUrl('toggleLinkType');
