...
async function executeDB(operation) {
    ...
    try {
        ...
        if (!db) {
            log("ERROR", "Unable to open MongoDB connection @executeDB.");
            return null;
        }
    ...
    // Catch errors
        ...
        // Log the error
        log("ERROR", `Error during MongoDB operation @executeDB: ${operation.type} on ${operation.collectionName}`, error);
    ...
    // Always close the database connection
        ...
        if (db) {
            ...
            // Catch error
                ...
                log("ERROR", `Error closing DB connection @executeDB after ${operation.type} on ${operation.collectionName}`, closeError);
            }
        }
    }
}
